  ...
  return knex('expenses').del()
    .then(function () {
      ...
      return knex('expenses').insert([
        ...
        {id: 2, eventsId: 2, vacationsId: 1, vacationsTitle: "Winter", secondaryUsersId: 3, secondaryUsersFirstName: "Jane", secondaryUsersLastName: "Doe", expenseOwed: 15.25, secondaryUsersExpense: 200.00},
